...
const UsersDelete = ({ history }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setUsers(result.data.map(user => ({ ...user, state: false })));
      } catch (e) {
  ...
  const handleSaveClick = async () => {
    ...
    updatedUsers.map(user => bodyFormData.set(user.id, user.state));
    try {
                ...
                return (
                  ...
                  >
                    ...
                    <div className={classes.details}>
                      <Badge
                        badgeContent={user.state ? 'DELETE' : ''}
                        invisible={!user.state}
